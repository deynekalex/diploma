...
import ru.ifmo.ctddev.deyneka.experiment2.MelifRunner;
import ru.ifmo.ctddev.deyneka.experiment2.SinglePointResultGetter;
...
public class MainExperiment {
    ...
    public static void experiment2() throws IOException {
        ...
        double radius = 1.0;
        out = new PrintWriter("experiment7_main_mean.csv");
